...
# import heapq
# def download(url, outpath="C:\\Users\\eswar\\Desktop\\vscode\\video_text\\videos"):
...
# 	clip.audio.write_audiofile("C:\\Users\\eswar\\Desktop\\vscode\\video_text\\audios\\test.wav",codec='pcm_s16le')
# 	print("Audio file has been generated")
# 	return 'C:\\Users\\eswar\\Desktop\\vscode\\video_text\\audios\\test.wav'
...
# 	folder_name = "C:\\Users\\eswar\\Desktop\\vscode\\video_text\\audios\\chunks"
...
# def clearFiles(path = 'C:\\Users\\eswar\\Desktop\\vscode\\video_text\\audios\\chunks'):
...
def download(url, outpath="C:\\Users\\Sowmya Mallavolu\\Desktop"):
	yt = YouTube(url)
	print("Downloading video...")
	path = yt.streams.filter(file_extension="mp4").get_by_resolution("360p").download(outpath)
	print("Path of the downloaded file:",path)
...
def convertAudio(path):
	print("Converting to audio file")
	clip = mp.VideoFileClip(path)
	clip.audio.write_audiofile("C:\\Users\\Sowmya Mallavolu\\Desktop\\test.wav",codec='pcm_s16le')
	print("Audio file has been generated")
	return 'C:\\Users\\Sowmya Mallavolu\\Desktop\\test.wav'
